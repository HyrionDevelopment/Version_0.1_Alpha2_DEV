...
class Mysql extends config
{
	...
	{
			$this->db_host = $this->config_db_host;
			$this->db_user = $this->config_db_user;
			$this->db_pass = $this->config_db_pass;
			$this->db_name = $this->config_db_name;
	}
	...
	function query2($sql, $data=null, $show_query = false)
	{
		$this->controleer_verbinding();
		...
		{
			return mysql_query($sql, $this->db_conn)or die(mysql_error());
		}
	}
